...
plt.savefig(os.path.join(fig_dir, 'ethnicity_neg_white_black_kneurons_distribution.pdf'), dpi=100)
plt.close()
...
for rel, kn_bag_list in kn_bag_list_per_rel.items():
    ...
    for i in range(0, len_kn_bag_list):
        for j in range(0, 100):
            kn_bag_1 = kn_bag_list[i]
            # print(kn_bag_list_per_rel.keys())
            # print('rel', rel)
