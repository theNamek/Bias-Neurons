...
fig_dir = '../bias_component_results_ori_v2/figs/'
...
plt.yticks(np.arange(-0.4, 0.5, 0.1), labels=[f'{np.abs(i)}%' for i in range(-40, 50, 10)], fontsize=9)
...
plt.savefig(os.path.join(fig_dir, 'ethnicity_neg_white_black_bneurons_distribution.pdf'), dpi=100)
plt.close()
